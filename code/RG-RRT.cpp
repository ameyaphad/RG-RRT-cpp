...
#include "RG-RRT.h"
 // #include "ompl/control/planners/rrt/RGRRT.h"
...
#include <ompl/control/spaces/RealVectorControlSpace.h>
 ...
 ompl::control::RGRRT::RGRRT(const SpaceInformationPtr &si,int robot_) : base::Planner(si, "RGRRT")
 {
 ...
 void ompl::control::RGRRT::setup()
 {
     ...
     nn_->setDistanceFunction([this](const Motion *a, const Motion *b) { return distanceFunction(a, b, si_); });
 }
 ...
 ompl::base::PlannerStatus ompl::control::RGRRT::solve(const base::PlannerTerminationCondition &ptc)
 {
     ...
     while (ptc == false)
     {
         ...
         //computeReachableSet(nmotion, si_, timeStep);
         ...
         if (addIntermediateStates_)
         {
             ...
             if (cd >= siC_->getMinControlDuration())
             {
                 ...
                 for (; p < pstates.size(); ++p)
                 {
                     ...
                     //ompl::control::SpaceInformationPtr si_new = siC_->shared_from_this();
                     // auto sharedompl::control::SpaceInformationPtr si_new(siC_);

                     computeReachableSet(motion, siC_, timeStep,robot);
